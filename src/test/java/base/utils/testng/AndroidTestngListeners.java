...
public class AndroidTestngListeners extends AndroidAppiumFactory implements ITestListener, IInvokedMethodListener, ISuiteListener, IAnnotationTransformer {
...
//        captureScreenShot(iTestResult);
    ...
    public void onStart(ISuite iSuite) {
        try {
            // EmulatorManager.startEmulator(getPropValue("deviceName"));
    ...
    public void onFinish(ISuite iSuite) {
        ...
        quiteDriver();
        // EmulatorManager.killEmulator(getPropValue("deviceName"));
        extentReports.flush();
